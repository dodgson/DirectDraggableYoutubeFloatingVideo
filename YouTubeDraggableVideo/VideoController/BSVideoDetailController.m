...
-(void)addVideo
{
    ...
    //   NSURL* srcurl = [NSURL URLWithString:@"https://www.youtube.com/embed/We3uAyJJ9Fo?feature=player_detailpage&playsinline=1"];
    NSDictionary *videos = [HCYoutubeParser h264videosWithYoutubeURL:[NSURL URLWithString:@"ttps://www.youtube.com/embed/jyofdUj6Ttg?feature=player_detailpage&playsinline=1"]];
    ...
    player  = [[MPMoviePlayerController alloc] initWithContentURL:[NSURL URLWithString:[videos objectForKey:@"medium"]]];
